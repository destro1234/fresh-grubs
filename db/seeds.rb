...
order1 = Order.create(address: "33 Highland Avenue", customer: "Elias" , total: 100, user_id: 1)
order2 = Order.create(address: "33 Highland Avenue", customer: "Elias" , total: 50, user_id: 1)
order3 = Order.create(address: "33 Highland Avenue", customer: "Elias" , total: 75, user_id: 2)
order4 = Order.create(address: "33 Highland Avenue", customer: "Elias" , total: 57.99, user_id: 2)
order5 = Order.create(address: "33 Highland Avenue", customer: "Elias" , total: 60, user_id: 3)
order6 = Order.create(address: "33 Highland Avenue", customer: "Elias" , total: 49.99, user_id: 3)
